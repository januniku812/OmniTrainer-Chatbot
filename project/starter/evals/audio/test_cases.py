...
print(f"@audio/test_cases.py inserted sys path for evaluators import as: {str(Path(__file__).parent)}")
from evals.audio.evaluators import AudioModerationCheck, HasTranscription
...
async def main():
    ...
    # save to html file 
    with open("eval_audio_test_cases_report.html", "w", encoding="utf-8") as f:
