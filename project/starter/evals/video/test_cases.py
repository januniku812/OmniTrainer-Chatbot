...
print(f"@video/test_cases.py inserted sys path for evaluators import as: {str(Path(__file__).parent)}")
from evals.video.evaluators import VideoModerationCheck
...
async def main():
    ...
    # save to html file 
    with open("eval_video_test_cases_report.html", "w", encoding="utf-8") as f:
